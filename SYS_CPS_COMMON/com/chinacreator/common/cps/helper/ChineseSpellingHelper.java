...
public class ChineseSpellingHelper {
	...
	private static ChineseSpellingHelper chineseSpelling = new ChineseSpellingHelper();

	public static ChineseSpellingHelper getInstance() {
