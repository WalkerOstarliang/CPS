...
/*
-- 检查下面记录是否已经插入了，如果有了就不需要执行了，如果没有，则插入下列记录。

insert into TD_SQJW_SqDetailColumnInfo (ID, CODE, SHOWCOLNAME, WIDTHNUM, 

COLNAME, ALIGN, ORDNUM, ISPARAM)
values (157, 'rsdq', '详情', '5%', 'ajbh', 'center', 1, 1);
...
COLNAME, ALIGN, ORDNUM, ISPARAM)
values (158, 'rsdq', '案件名称', '30%', 'ajmc', 'left', 2, 0);
...
COLNAME, ALIGN, ORDNUM, ISPARAM)
values (159, 'rsdq', '案件类型', '10%', 'ajlx', 'center', 3, 0);
...
COLNAME, ALIGN, ORDNUM, ISPARAM)
values (160, 'rsdq', '文书文号', '45%', 'wswh', 'left', 4, 0);
...
COLNAME, ALIGN, ORDNUM, ISPARAM)
values (161, 'rsdq', '受理日期', '10%', 'slrq', 'center', 5, 0);
