...
values (seq_common.nextval, 'ZDY_HYLB', '行业类别', '12', '物流寄递业', '', '', '1', null);
commit;

-- Add/modify columns 
alter table T_COMMON_PCSJBQKTJB add SQJWSLWS number;
alter table T_COMMON_PCSJBQKTJB add NCJWSLWS number;
-- Add comments to the columns 
comment on column T_COMMON_PCSJBQKTJB.SQJWSLWS
  is '社区警务室联网数';
comment on column T_COMMON_PCSJBQKTJB.NCJWSLWS
  is '农村警务室联网数';
