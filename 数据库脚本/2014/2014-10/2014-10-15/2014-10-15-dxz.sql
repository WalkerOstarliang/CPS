alter table T_LSGL_RK_JBXX modify ZYDM VARCHAR2(30);
                  ...
                  --社区(驻村)警务室配备流动人口与出租屋协管员数
                   ...
                   INSERT INTO T_COMMON_PCSJBQKTJB
                    (ID, ORGCODE, ORGNAME, LEVE,PARENTCODE, ZJLS, PCSZS,
                         ...
                         JWSLGANWS,STPZS,PCSZFBZFJS,PCSLDRKXGYS,PCSXFDYS,SQJWSPBZFBZFJS,SQJWSPBXFDYS,SQJWSPBLKXGYS,JSQJWSS)
                   VALUES
                    (I, LIST(I).ORGCODE, LIST(I).ORGNAME, LIST(I).LEVE,LIST(I).PARENT_CODE, V_ZJLS, V_PCSZS,
                        ...
                        V_JWSLGANWS,V_STPZS,V_PCSZFBZFJS,V_PCSLDRKXGYS,V_PCSXFDYS,V_SQJWSPBZFBZFJS,V_SQJWSPBXFDYS,V_SQJWSPBLKXGYS,V_JSQJWSS);
                   COMMIT;
...
UPDATE   t_common_dictionary  SET parent_dm = '3' WHERE zdlb = 'ZAGL_ZDDJ' AND (dm = '3' OR dm = '4');
COMMIT;