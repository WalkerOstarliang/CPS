			...
			<div class="warp">
		        ...
		        <div style="width:100%; height:68px;padding: 0px">
			        ...
			        <div id="menudiv" class="top_menu02">
			         	...
			         	<a id="dtcj" href="<c:url value='/pgis/toIndex.action'/>" class="menu_link" target="_blank">地图采集</a>
			         	<a id="dzgl" href="javascript:void(0)" onclick="redirectPage(this,'dzgl','')" class="menu_link">地址管理</a>
			         	<a id="lsgl" href="javascript:void(0)" onclick="redirectPage(this,'lsgl','')" class="menu_link">两实管理</a>
			         	<a id="zagl" href="javascript:void(0)" onclick="redirectPage(this,'zagl','')" class="menu_link">实有单位</a>
			         	<a id="afff" href="javascript:void(0)" onclick="redirectPage(this,'aqff','')" class="menu_link">安全防范</a>
			         	<%-- 
			         	<a id="zdry" href="javascript:void(0)" onclick="redirectPage(this,'zdry','')" class="menu_link" >重点人员</a>
			         	--%>
			         	<a id="qbxs" href="javascript:void(0)" onclick="redirectPage(this,'qbxs','')" class="menu_link">情报线索</a>
			         	<a id="gzgl" href="javascript:void(0)" onclick="redirectPage(this,'gzgl','')" class="menu_link">工作管理</a>
			         	<%-- 
			         	<a id="khkp" href="javascript:void(0)" onclick="redirectPage(this,'khkp','')" class="menu_link">考核统计</a>
			         	--%>
			         	<a id="pcsgl" href="javascript:void(0)" onclick="redirectPage(this,'pcsgl','')" class="menu_link">派出所管理</a>
			         	<a id="tjbb" href="javascript:void(0)" onclick="redirectPage(this,'tjfx','')" class="menu_link">统计报表</a>
			         	<a id="zhcx" href="http://10.142.56.157:8185/qwjs/" target="_blank" class="menu_link">综合查询</a>
			         	<a id="zhcx" href="http://10.142.56.122:8888/" target="_blank" class="menu_link">标准机构</a>
			         	<%-- 
