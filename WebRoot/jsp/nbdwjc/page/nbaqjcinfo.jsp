...
<%--  内保单位安全检查 --%>
<creator:view>
	<creator:Script src="/jsp/nbdwjc/js/nbaqjc.js"></creator:Script>
	
	<creator:box>
		<cps:PanelView>
			<cps:tbar>
				<cps:button value="保存" onclick="saveAqjc()" id="savebutton"></cps:button>
				...
				<form id="aqjcForm">
					...
					<cps:table>
						...
						<cps:row>
							...
							<cps:tdContent>
								<cps:textfield name="aqjc.jcmjxm" value="${aqjc.jcmjxm}" id="jcmjxm" required="true" readonly="true" appendPopuBtn="true" onclick="orgUserSelect('${loginInfo.rootOrgCode}','jcmjjh','jcmjxm')"></cps:textfield>
			...
			<cps:tableGrid url="/nbdwaqjc/queryAqjcList.action" title="历史安全检查"
							id="aqjclist" autoload="true" pageSize="5" width="99.8%" click="rowclick"
							usepager="true" searchform="queryform" autothead="false" mutilSelect="true">
				<cps:column isNumber="true" title="序号"></cps:column>
				<cps:column title="单位名称" field="dwmc" align="left"></cps:column>
				<cps:column title="检查日期" field="jcrq"></cps:column>
				<cps:column title="检查民警" field="jcmjxm" align="left"></cps:column>
				<cps:column title="检查情况描述" field="jcqkms" align="left"></cps:column>
