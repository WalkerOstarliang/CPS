		...
		<cps:row>
			<cps:tdContent valign="top" width="10%">
				<div style="height: 100%;width:100%">
					<div id="header">
						<div id="head_title" style="text-align: center;" class="cps-box-title">流动人口信息</div>
						...
						<div id="head_title" style="text-align: center;" class="cps-box-title">
						 ...
						 <div class="left_menubox">
					    	...
					    	<a href="<c:url value='/lsgl/rk/toRkLsjzListPage.action'/>?jsppage=ldrklsjzxx&operType=${operType}&queryBean.sfzh=${queryBean.sfzh}&queryBean.fwid=${queryBean.fwid}&queryBean.rylb=${queryBean.rylb}" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;居住历史信息</a>
					    </div>
					</div>
				</div>
			</cps:tdContent>
			<cps:tdContent valign="top" width="90%">
				<iframe id="centerFrame" name="centerFrame" frameborder="0" scrolling="no" src="<c:url value='/lsgl/rk/toRkJbxxInfo.action'/>?queryBean.cyrybh=${queryBean.cyrybh}&opentip=true&queryBean.rkid=${queryBean.rkid}&queryBean.sfzh=${queryBean.sfzh}&queryBean.fwid=${queryBean.fwid}&queryBean.rylb=${queryBean.rylb}" width="100%" height="100%">
			</cps:tdContent>
		</cps:row>
	</cps:table>
</div>
