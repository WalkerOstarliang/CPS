...
<cps:tbar id="jzzxxTbar">
	<c:if test="${operType != 'detail'}">
		<cps:button id="jzzSaveButton" value="保存" onclick="YqsaveJzzxxBean();"></cps:button>
		<cps:button value="居住证打印" onclick="preJzzxxDy('1');"></cps:button>
		<!-- 
...
<cps:panel id="jzzxxPanel"  title="人员基本信息">
	...
	<creator:panel id="jzzdjxx" title="居住证信息登记">
		<form id="jzzxxForm">
			...
			<input type="hidden" id="yjzzxxbh" name="yjzzxxbh" value="${yjzzxxbh}" >
