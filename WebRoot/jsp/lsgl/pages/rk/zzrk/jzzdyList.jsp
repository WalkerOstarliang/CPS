				...
				<cps:table>
					<cps:row>
						...
						<cps:tdContent>
							...
							<c:if test="${loginInfo.leve == 4}">
								<s:select id="pcsdm" list="kfwPcsGajgjgList"  name="queryBean.pcsdm" listKey="dm" listValue="jc" headerKey="" headerValue="--请选择--" cssClass="cps-select" onchange="doubleSelectJWS(this.value,'jwsselect')"></s:select>
							</c:if>
							<c:if test="${loginInfo.leve > 4}">
