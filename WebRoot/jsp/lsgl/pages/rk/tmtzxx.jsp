...
<creator:tbar id="tmtzxxsavetbar">
	<cps:button value="保存" onclick="submitFormRkInfo(saveTmtzAfterCallback)"></cps:button>
	<cps:button value="关闭" onclick="$.closeWindow()"></cps:button>
</creator:tbar>
<c:if test="${operType!='rydaxx'}">
<creator:panel id="tmtzxxpanel" title="体貌特征信息" tbarId="tmtzxxsavetbar">
	...
	<cps:table>
		<cps:row>
			...
			<cps:tdContent width="22%">
				<cps:select zdlb="GB_TX" id="tx" name="rkBean.tmtzBean.tx" value="${rkBean.tmtzBean.tx}" headerKey="" headerValue=" " required="true" cssStyle="width:90%"></cps:select>
			</cps:tdContent>
			<cps:tdLabel width="12%"><font color="red">*</font>口音：</cps:tdLabel>
			<cps:tdContent>
				<cps:select zdlb="GB_KY" id="ky" name="rkBean.tmtzBean.ky" value="${rkBean.tmtzBean.ky}" headerKey="" headerValue=" " required="true" cssStyle="width:90%"></cps:select>
			</cps:tdContent>
		</cps:row>
		<cps:row>
		...
		<cps:row cssClass="tstzrow">
			...
			<cps:tdContent>
				<cps:select zdlb="ZDY_TSTBJZ" id="tstzbj" name="rkBean.tmtzBean.tstzbj" value="${rkBean.tmtzBean.tstzbj}" headerKey="" headerValue=" " cssStyle="width:90%"></cps:select>
			</cps:tdContent>
			<cps:tdLabel>特殊标记部位：</cps:tdLabel>
			<cps:tdContent>
				<cps:select zdlb="ZDY_TSTZBW" id="tstzbw" name="rkBean.tmtzBean.tstzbw" value="${rkBean.tmtzBean.tstzbw}" headerKey="" headerValue=" " cssStyle="width:94%"></cps:select>
			</cps:tdContent>
		</cps:row>
		<cps:row cssClass="tstzrow">
			...
			<cps:tdContent>
				<cps:select zdlb="ZDY_TSTZFW" id="tstzfw" name="rkBean.tmtzBean.tstzfw" value="${rkBean.tmtzBean.tstzfw}" headerKey="" headerValue=" " cssStyle="width:90%"></cps:select>
			</cps:tdContent>
			<cps:tdLabel>特殊特征数量：</cps:tdLabel>
			<cps:tdContent>
				<cps:select zdlb="ZDY_TSTZSL" id="tstzsl" name="rkBean.tmtzBean.tstzsl" value="${rkBean.tmtzBean.tstzsl}" headerKey="" headerValue=" " cssStyle="width:94%"></cps:select>
			</cps:tdContent>
		</cps:row>
		<cps:row>
			...
			<cps:tdContent>
				<cps:textfield id="xh" name="rkBean.tmtzBean.xh" value="${rkBean.tmtzBean.xh}" cssStyle="width:90%" inputType="number" maxlength="2"></cps:textfield>
			</cps:tdContent>
			<cps:tdLabel>备注：</cps:tdLabel>
			<cps:tdContent>
				<cps:textfield id="bz" name="rkBean.tmtzBean.bz" value="${rkBean.tmtzBean.bz}" cssStyle="width:98%;" maxlength="150"></cps:textfield>
			</cps:tdContent>
		</cps:row>
		<cps:row>
			...
			<cps:tdContent>
				<c:choose>
					<c:when test="${empty rkBean.tmtzBean.czdwdm }">
						...
						<cps:textfield id="czdwmc" name="rkBean.tmtzBean.czdwmc" readonly="true" value="${loginInfo.orgname}" cssStyle="width:90%"></cps:textfield>
					</c:when>
					<c:otherwise>
						<input type="hidden" name="rkBean.tmtzBean.czdwdm" value="${rkBean.tmtzBean.czdwdm}"/>
						<cps:textfield id="czdwmc" name="rkBean.tmtzBean.czdwmc" readonly="true" value="${rkBean.tmtzBean.czdwmc}" cssStyle="width:90%"></cps:textfield>
					</c:otherwise>
				</c:choose>
			</cps:tdContent>
			...
			<cps:tdContent>
				<c:choose>
					<c:when test="${empty rkBean.tmtzBean.djsj }">
						<cps:date id="czsj" name="rkBean.tmtzBean.czsj" readOnly="true" defaultSystemDate="true" cssStyle="width:90%"></cps:date>
					</c:when>
					<c:otherwise>
						<cps:date id="czsj" name="rkBean.tmtzBean.czsj"  value="${rkBean.tmtzBean.czsj}" cssStyle="width:90%"></cps:date>
					</c:otherwise>
				</c:choose>
			</cps:tdContent>
		</cps:row>
		...
		<cps:row>
			<c:if test="${empty rkBean.tmtzBean.djrxm }">
				...
				<cps:tdContent>
					...
					<cps:textfield id="djdwmc" name="rkBean.tmtzBean.djdwmc" value="${loginInfo.orgname}" readonly="true" cssStyle="width:90%"></cps:textfield>
				</cps:tdContent>
				<cps:tdLabel>登记时间：</cps:tdLabel>
				<cps:tdContent>
					<cps:date id="djsj" name="rkBean.tmtzBean.djsj"  defaultSystemDate="true" cssStyle="width:90%"></cps:date>
				</cps:tdContent>
			</c:if>
			<c:if test="${!empty rkBean.tmtzBean.djrxm }">
				<cps:tdLabel >登记民警：</cps:tdLabel>
				...
				<cps:tdContent>
					...
					<cps:textfield id="djdwmc" name="rkBean.tmtzBean.djdwmc" value="${rkBean.tmtzBean.djdwmc}" readonly="true" cssStyle="width:90%"></cps:textfield>
				</cps:tdContent>
				<cps:tdLabel>登记时间：</cps:tdLabel>
				<cps:tdContent>
					<cps:date id="djsj" name="rkBean.tmtzBean.djsj"  value="${rkBean.tmtzBean.djsj}" cssStyle="width:90%"></cps:date>
				</cps:tdContent>
			</c:if>
		</cps:row>
	</cps:table> 
