					...
					<div id="header">
						...
						<div id="head_title" style="text-align: center;" class="cps-box-title">
						 ...
						 <div class="left_menubox">
					    	<a href="<c:url value='/lsgl/rk/toRkJbxxInfo.action'/>?operType=${operType}&queryBean.rybh=${queryBean.rybh}&queryBean.fwid=${queryBean.fwid}&queryBean.rylb=${queryBean.rylb}" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;人口基本信息</a>
					    	...
					    	<a href="<c:url value='/lsgl/rk/toRkLsjzListPage.action'/>?jsppage=czrklsjzxx&operType=${operType}&queryBean.sfzh=${queryBean.sfzh}&queryBean.fwid=${queryBean.fwid}&queryBean.rylb=${queryBean.rylb}" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;居住历史信息</a>
					    </div>
					</div>
				</div>
			</cps:tdContent>
			<cps:tdContent valign="top" width="90%">
				<iframe id="centerFrame" name="centerFrame" frameborder="0" scrolling="no" src="<c:url value='/lsgl/rk/toRkJbxxInfo.action'/>?opentip=true&queryBean.sfzh=${queryBean.sfzh}&queryBean.fwid=${queryBean.fwid}&queryBean.rylb=${queryBean.rylb}" width="100%" height="100%">
			</cps:tdContent>
		</cps:row>
	</cps:table>
</div>
