...
<creator:view>
	...
	<script type="text/javascript">
		var isydj = "${rkBean.jzrkBean.jzbh != null && rkBean.jzrkBean.jzbh != ''}";
		var opentip = "${opentip}";
	...
	<form id="rkxxform" method="post">
		...
		<cps:PanelView>
			<cps:tbar>
				<cps:button id="savebtn" value="保存" onclick="saveJzrkBean()"></cps:button>
				<cps:button value="关闭" onclick="closeWindow()"></cps:button>
			</cps:tbar>
			<cps:panel id="rkjbxx" title="人口基本信息" height="720px">
