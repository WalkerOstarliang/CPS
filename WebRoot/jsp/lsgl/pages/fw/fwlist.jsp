...
<creator:view width="99.5%">
	...
	<creator:box>
		...
		<creator:tbar id="fwtooltbar">
			...
			<cps:button value="新增房屋" onclick="openNewFwInfo('add','','${queryBean.sfczw}')" display="${displayAddBtn}"></cps:button>
			<cps:button value="出租房屋登记" onclick="openDjfwForCzfwInfo()" display="${displayAddBtn}"></cps:button>
			<cps:button value="实有人口新增" onclick="openSyrkRkInfo('add','')" display="${displayAddBtn}"></cps:button>
			...
			<cps:button value="导出房屋信息" onclick="exportFwJbxxExcel()"></cps:button>
		</creator:tbar>
		<creator:panel id="fwquerypanel" title="房屋查询条件" tbarId="fwtooltbar">
			...
			<cps:table>
				...
				<cps:row>
					...
					<cps:tdContent>
						<cps:date id="djsj_start" cssStyle="width:37%" name="queryBean.djsj_start" maxDate="${queryBean.djsj_end}" dateFmt="yyyy-MM-dd"></cps:date>
						至
						<cps:date id="djsj_end"   cssStyle="width:37%" minDateDepend="djsj_start" name="queryBean.djsj_end" maxDate="${queryBean.djsj_end}" dateFmt="yyyy-MM-dd"></cps:date>
					</cps:tdContent>
					<cps:tdLabel>注销状态：</cps:tdLabel>
					<cps:tdContent>
						<cps:select id="fwzxbs" name="queryBean.fwzxbs" zdlb="ZDY_ZXBS" headerKey="" headerValue=" " value="0" ></cps:select>
					</cps:tdContent>
		...
		<creator:tbar id="syrkimporttbar">
			<cps:button value="实有人口导入" onclick="openSyrkImportWin()" display="${displayAddBtn}"></cps:button>
		</creator:tbar>
		<cps:tableGrid id="fwtablegrid"  title="房屋列表" tbarId="syrkimporttbar"
			...
			<cps:column field="cz" title="操作" align="center" width="110"></cps:column>
			...
			<cps:column field="fwzxbsms" title="注销状态"></cps:column>
