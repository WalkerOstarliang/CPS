	...
	<div class="PageNext" style="layout-grid:15.6pt;" >
		<table class="MsoNormalTable border="0 cellspacing="0 cellpadding="0
		 ...
		 <tr style="height:22.5pt">
		  ...
		  <b>
		  <span style="font-size:18.0pt;font-family:黑体">${pcsBean.orgname }</span>
		  </b>
		  </p>
		  </td>
		 </tr>
		<tr style='height:22.5pt'>
		 ...
		 <tr style="height:36.75pt">
		  ...
		  style="font-size:10.0pt;font-family:仿宋_GB2312">&nbsp;&nbsp;&nbsp;${rkBean.jwrkBean.ywm}.${rkBean.jwrkBean.ywx}</span></p>
		  </td>
		 </tr>
		 <tr style="height:36.75pt">
		  <td width="145" colspan="2" style="width:109.1pt;border:solid windowtext 1.0pt;
		  ...
		  style="font-size:10.0pt;font-family:仿宋_GB2312">${rkBean.jbxxBean.xm}</span></p>
		  </td>
		  ...
		  padding:0cm 5.4pt 0cm 5.4pt;height:36.75pt">
		  <p class="MsoNormal" align="center" style="text-align:center"><span lang="EN-US"
		  style="font-size:10.0pt;font-family:仿宋_GB2312">${rkBean.jbxxBean.gjms}</span></p>
		  </td>
		 </tr>
		 <tr style="height:36.75pt">
		  <td width="145" colspan="2" style="width:109.1pt;border:solid windowtext 1.0pt;
		  ...
		  style="font-size:10.0pt;font-family:仿宋_GB2312">
		   <c:choose>
		  	<c:when test="${rkBean.jbxxBean.xb == '1'}">
		  		男●<br>
		  	</c:when>
		  	<c:otherwise>
		  		男○<br>
		   ...
		   <c:choose>
		  	<c:when test="${rkBean.jbxxBean.xb == '2'}">
		  		女●
		  	</c:when>
		  	<c:otherwise>
		  		女○
		  ...
		  <c:choose>
		  	<c:when test="${rkBean.jwrkBean.jwrylx == '0'}">
		  		 ■常住（居住6个月以上）□临住
		  	</c:when>
		  	<c:otherwise>
		  		 □常住（居住6个月以上）■临住
		 ...
		 <tr style="height:28.5pt">
		  ...
		  <p class="MsoNormal" style="text-indent:65.0pt"><span style="font-size:10.0pt;
		  font-family:仿宋_GB2312">${rkBean.jbxxBean.csrq}</span></p>
		  </td>
		 </tr>
		 <tr style="height:25.5pt">
		  ...
		  <p class="MsoNormal" align="left" style="text-align:left"><span lang="EN-US"
		  style="font-size:10.0pt;font-family:仿宋_GB2312">&nbsp;&nbsp;&nbsp;${rkBean.jbxxBean.lxdh}</span></p>
		  </td>
		 </tr>
		 <tr style="height:30.0pt">
		  ...
		  <p class="MsoNormal" align="center" style="text-align:center"><span
		  style="font-size:10.0pt;font-family:仿宋_GB2312">所持证件<span lang="EN-US">*</span></span></p>
		  <p class="MsoNormal" align="center" style="text-align:center"><span
		  style="font-size:10.0pt;font-family:仿宋_GB2312">种类</span></p>
		  </td>
		  <td width="493" colspan="4" style="width:370.1pt;border-top:none;border-left:
		  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
		  padding:0cm 5.4pt 0cm 5.4pt;height:30.0pt">
		  <p class="MsoNormal>
		  <span style="font-size:10.0pt;font-family:仿宋_GB2312">
		  <c:choose>
		  	<c:when test="${(rkBean.jbxxBean.zjzl == '213') 
		  					|| (rkBean.jbxxBean.zjzl == '211')
		  					|| (rkBean.jbxxBean.zjzl == '214')
		  					|| (rkBean.jbxxBean.zjzl == '270')
		  					|| (rkBean.jbxxBean.zjzl == '212')
		  					|| (rkBean.jbxxBean.zjzl == '271') }">
		  		●护照
		  	</c:when>
		  	<c:otherwise>
		  		○护照
		  ...
		  <c:choose>
		  	<c:when test="${rkBean.jbxxBean.zjzl == '221'}">
		  		●港澳居民通行证
		  	</c:when>
		  	<c:otherwise>
		  		○港澳居民通行证
		  ...
		  <c:choose>
		  	<c:when test="${rkBean.jbxxBean.zjzl == '216'}">
		  		●台胞证
		  	</c:when>
		  	<c:otherwise>
		  		○台胞证
		  ...
		  <c:choose>
		  	<c:when test="${rkBean.jbxxBean.zjzl == '111'
		  					||rkBean.jbxxBean.zjzl == '215'
		  					||rkBean.jbxxBean.zjzl == '230'
		  					||rkBean.jbxxBean.zjzl == '990'}">
		  		●其它
		  	</c:when>
		  	<c:otherwise>
		  		○其它
		 ...
		 <tr style="height:28.5pt">
		  ...
		  border-top:none;padding:0cm 5.4pt 0cm 5.4pt;height:28.5pt">
		  <p class="MsoNormal" align="center" style="text-align:center"><span
		  style="font-size:10.0pt;font-family:仿宋_GB2312">所持证件</span></p>
		  <p class="MsoNormal" align="center" style="text-align:center"><span
		  style="font-size:10.0pt;font-family:仿宋_GB2312">号码<span lang="EN-US">*</span></span></p>
		  </td>
		  <td width="493" colspan="4" style="width:370.1pt;border-top:none;border-left:
		  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
		  padding:0cm 5.4pt 0cm 5.4pt;height:28.5pt">
		  <p class="MsoNormal"><span lang="EN-US" style="font-size:10.0pt;font-family:仿宋_GB2312">&nbsp;&nbsp;&nbsp;${rkBean.jbxxBean.zjhm}</span></p>
		  </td>
		 </tr>
		 <tr style="height:36.75pt">
		  <td width="145" colspan="2" style="width:109.1pt;border:solid windowtext 1.0pt;
		  ...
		  padding:0cm 5.4pt 0cm 5.4pt;height:36.75pt">
		  <p class="MsoNormal" align="left" style="text-align:left"><span lang="EN-US"
		  style="font-size:10.0pt;font-family:仿宋_GB2312">&nbsp;&nbsp;&nbsp;${rkBean.jbxxBean.xzzxz}</span></p>
		  </td>
		 </tr>
		 <tr style="height:34.5pt">
		  ...
		  <p class="MsoNormal"><span lang="EN-US" style="font-size:10.0pt;font-family:仿宋_GB2312">&nbsp;&nbsp;&nbsp;${rkBean.jwrkBean.bz}</span></p>
		  </td>
		 </tr>
