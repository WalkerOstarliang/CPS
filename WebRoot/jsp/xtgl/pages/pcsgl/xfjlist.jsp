...
<creator:view width="99.8%">
	...
	<form id="hiddenform">
	<input type="hidden" id="fjlb" name="queryBean.fjlb" value="3">
	...
	<cps:tbar>
		...
		<cps:button value="新增" onclick="openFjPage('','add','3')"></cps:button>
		<cps:button value="导出" onclick="exportLkXgyInfo()"></cps:button>
	</cps:tbar>
	<cps:panel id="fwquerypanel" title="政法协辅警查询" >
			<cps:table>
					<cps:row>
				...
				<cps:row>
					...
					<cps:tdContent>
						<cps:select zdlb="ZDY_LKXGYGW" parentDm="3" id="gzgw" name="queryBean.gzgw" headerKey="" headerValue=" " value="0"></cps:select>
					</cps:tdContent>
