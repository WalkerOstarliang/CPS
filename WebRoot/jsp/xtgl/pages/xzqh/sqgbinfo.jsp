...
<creator:view title="社区干部管理">
	<creator:Script src="/jsp/afgl/js/sqgbinfo.js"></creator:Script>
	<creator:tbar  id="sqglinfotab">
		<cps:button id="savebtn" value="保&nbsp;存" onclick="submitSqgbSave()"></cps:button>
		<cps:button value="关&nbsp;闭" onclick="$.closeWindow()"></cps:button>
	</creator:tbar>
	<creator:panel id="xldglpanel" title="社区干部基本信息" tbarId="sqglinfotab">
		...
		<s:hidden id="lx" name="bean.lx" value="1"></s:hidden>
		<s:hidden id="sssqbh" name="bean.sssqbh"></s:hidden>
		<input id="sssqmc" name="bean.sssqmc" type="hidden" value="${bean.sssqmc }">
				...
				<cps:tdContent width="90%">
					<cps:table>
						...
						<cps:row id="clear_row3">
							...
							<cps:tdLabel><font color="red">*</font>学历：</cps:tdLabel>
							<cps:tdContent>
						...
						<cps:row id="clear_row3">
							...
							<cps:tdContent>
								<cps:date id="gbdrsj" name="bean.gbdrsj" value="${bean.gbdrsj}" dateFmt="yyyy-MM-dd"></cps:date>
							</cps:tdContent>
						</cps:row>
						<cps:row id="clear_row5">
					 	...
					 	<cps:row id="clear_row8">
							...
							<cps:tdContent colspan="5">
								<s:checkboxlist list="gbzwList" id="gbzw" name="bean.gbzws" listKey="dm" listValue="mc" cssClass="validate[required]"></s:checkboxlist>
							</cps:tdContent>
						</cps:row>
						<cps:row id="clear_row7">
							...
							<cps:tdContent>
								<cps:date id="gbdcsj" name="bean.gbdcsj" value="${bean.gbdcsj}"></cps:date>
							</cps:tdContent>
						...
						<cps:row>
							...
							<cps:tdContent>
								<cps:date id="djsj" name="bean.djsj" defaultSystemDate="true" readOnly="true"></cps:date>
							</cps:tdContent>
						</cps:row>
					</cps:table>
				</cps:tdContent>
				<cps:tdContent valign="top">
					<img id="gbzpxx" src="<c:url value='/cps/common/showPoto.action'/>?sfzh=${bean.gbsfzh}" width="130px" height="140px" />
				</cps:tdContent>
			</cps:row>
		</cps:table>
	</form>
