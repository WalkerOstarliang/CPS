		            ...
		            <td valign="top" width="100%">
		           	 	<div style="padding:5px;;width:100%;height: 100%">
			       	    	<div class="zfba_leftbox" style="border: 0px solid red;">
			                	<div><img src="<c:url value='/jsp/cs/images/zfba_a.jpg'/>" width="140" height="15" /></div>
			                    	<div id="leftpanel" class="zfba_menu" style="padding:0 10px;height: 400px">
			                    		<a href="<c:url value='/xtgl/pcs/toPcsglPage.action'/>" class="zfba_b" target="mainiframe">派出所管理</a>
			                    		<a href="<c:url value='/gzgl/userlxsfgl/toUserLxfsList.action'/>" class="zfba_b" target="mainiframe">警员信息管理</a>
			                    		<a href="<c:url value='/xtgl/pcs/toJwtglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">警务通管理</a>
			                    		<a href="<c:url value='/gzgl/gzjwsgl/toFzryglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">辅助人员管理</a>
			                    	</div>
			              	...
			              	<div class="zfba_rightbox" style="border: 0px solid red;">
			              		<iframe id="mainiframe" name="mainiframe" frameborder="0" src="<c:url value='/xtgl/pcs/toPcsglPage.action'/>" width="98.5%" height="500"></iframe>
			           	  	</div>
			           	</div>
		            </td>
		          </tr>
								...
								<div id="header">
									...
									<div id="zpxx" class="cps-box-content">
										<div id="leftpanel" class="zfba_menu" style="height: 400px">
									    	<a href="<c:url value='/xtgl/pcs/toPcsglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">派出所管理</a>
				                    		<a href="<c:url value='/gzgl/userlxsfgl/toUserLxfsList.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">警员信息管理</a>
				                    		<a href="<c:url value='/xtgl/pcs/toJwtglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">警务通管理</a>
				                    		<%-- 
				                    			<a href="<c:url value='/gzgl/gzjwsgl/toFzryglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">辅助人员管理</a>
				                    		--%>
				                    		...
				                    		<div class="menubox" style="display: none;">
				                    			<a href="<c:url value='/gzgl/gzjwsgl/toLkXgyglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">流口协管员管理</a>
			                    				<a href="<c:url value='/gzgl/gzjwsgl/toXfjglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">政法协辅警管理</a>
			                    				<a href="<c:url value='/gzgl/gzjwsgl/toXfdyglPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">巡防队员管理</a>
				                    		</div>
				                    		
				                    		<a href="<c:url value='/gzgl/pcsxchd/toPcsXcHdListPage.action'/>" class="zfba_b" target="mainiframe" style="text-align: left">宣传活动</a>
