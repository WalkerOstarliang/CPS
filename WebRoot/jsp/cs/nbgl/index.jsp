		            ...
		            <td valign="top" width="100%">
		           	 	<div style="padding:5px;;width:100%;height: 100%">
			       	    	<div class="zfba_leftbox" style="border: 0px solid red;">
			                	<div><img src="<c:url value='/jsp/cs/images/zfba_a.jpg'/>" width="140" height="15" /></div>
			                    	<div id="leftpanel" class="zfba_menu" style="padding:0 10px;height: 400px">
		                    				<a href="<c:url value='/zagl/dw/toNbdwcx.action?dwcx.hylb=03'/>" class="zfba_d" target="mainiframe">单位信息查看</a>
			                    			<a href="<c:url value='/zagl/dw/toDwtj.action'/>" class="zfba_d" target="mainiframe">单位信息统计</a>
			                    			<a href="<c:url value='/zagl/dw/toDwfatj.action'/>" class="zfba_d" target="mainiframe">发案信息统计</a>
			                    			<a href="<c:url value='/nbgl/gjc/toGjcListPage.action'/>" class="zfba_d" target="mainiframe">关键词管理</a>
			                    			<a href="<c:url value='/nbgl/ajhs/toAjListPage.action'/>" class="zfba_d" target="mainiframe">案件核查</a>
			                    	</div>
			              	...
			              	<div class="zfba_rightbox" style="border: 0px solid red;">
			              		<iframe id="mainiframe" name="mainiframe" frameborder="0" src="<c:url value='/zagl/dw/toNbdwcx.action?dwcx.hylb=03'/>" width="98.5%" height="500"></iframe>
			           	  	</div>
			           	</div>
		            </td>
		          </tr>
