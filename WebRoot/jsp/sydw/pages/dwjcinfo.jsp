...
<creator:view title="单位奖惩信息">
	...
	<form id="dw_form">
		<creator:tbar id="dwjc_op">
			...
			<cps:button value="重置" type="reset"/>
		...
		<creator:panel id="dwjc_panel" title="单位奖罚信息" tbarId="dwjc_op">
			<div id="dwjc_div">
				...
				<input type="hidden" name="dw.dwjc.jgbh" id="jgbh" value="${dwBean.dwjbxx.jgbh}" />
				...
				<cps:table>
					<cps:row>
						...
						<cps:tdContent width="23%">
							<s:select list="#{'0':'奖励','1':'处罚'}" name="dw.dwjc.jclb" value="dw.dwjc.jclb" id="jclb" cssClass="cps-select" headerKey="" headerValue=" " />
						</cps:tdContent>
					...
					<cps:row>
						...
						<cps:tdContent colspan="6">
							<cps:textfield name="dw.dwjc.cfyy" id="cfyy" value="${dw.dwjc.cfyy}" maxlength="500" cssStyle="width:97%;"></cps:textfield>
						</cps:tdContent>
					</cps:row>
					...
					<cps:row>
						...
						<cps:tdContent colspan="6">
							<cps:textfield type="textarea" name="dw.dwjc.cfnr" id="cfnr" maxlength="1500" value="${dw.dwjc.cfnr}" cssStyle="width:97%;height:60px;"></cps:textfield>
						</cps:tdContent>
					</cps:row>
