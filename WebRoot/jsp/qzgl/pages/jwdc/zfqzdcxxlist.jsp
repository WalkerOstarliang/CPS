...
<creator:box>
<creator:tbar id="zfqzdc">
	<cps:button value="查&nbsp;询" onclick="jxQuery()"></cps:button>&nbsp;
</creator:tbar>
	<creator:panel id="xldcx" title="走访管理>走访群众调查" tbarId="zfqzdc">
		<form id="xldqueryform">
			<cps:table>
				...
				<cps:row>
					...
					<cps:tdLabel width="10%">调查状态：</cps:tdLabel>
					<cps:tdContent width="25%">
				...
				<cps:tdLabel width="10%">走访民警：</cps:tdLabel>
					...
					<cps:tdLabel width="10%">走访对象：</cps:tdLabel>
					<cps:tdContent width="25%">
	...
	<cps:tableGrid id="xldquerylist" 
		...
		<cps:column field="sfjwdcmc" title="调查状态" maxlength="10"></cps:column>
