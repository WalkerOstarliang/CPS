...
<creator:view>
	<creator:box>
	<creator:tbar id="lxdjtbar">
			<cps:button value="查&nbsp;询" onclick="jxquery()"></cps:button>&nbsp;

			<cps:button value="新增" onclick="openInfoWin('add','')"></cps:button>

		</creator:tbar>
		<creator:panel id="lxdjcx" title="来访来信>来信来访登记" tbarId="lxdjtbar">
			<form id="lxdjqueryform">
				<cps:table>
					<cps:row>
		...
		<cps:tableGrid id="lxdjquerylist" mutilSelect="true"
			url="/qzgl/lxdjgl/queryLxdjBeanList.action" >
			...
			<cps:column field="lflxrlxdh" title="联系电话" maxlength="10"></cps:column>
			<cps:column field="lflxsj" title="来访时间"></cps:column>
			<cps:column field="sjjdmjdwmc" title="接待单位"></cps:column>
