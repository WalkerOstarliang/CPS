...
<body class="leftbox">
	...
	<div id="left_menu" class="left_menu">
	    ...
	    <div class="left_menubox" style="display: none">
	    	...
	    	<a href="<c:url value='/gzgl/tzgl/toXxyglList.action'/>" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;信息/耳目员</a>
	    </div>
	    ...
	    <a href="#" class="left_menu_main_b">义务巡逻队管理</a>
	     <div class="left_menubox" style="display: none">
	    	...
	    	<a href="<c:url value='/afgl/xldxx/toXldrxxPage.action'/>?queryBean.xldlx=2" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;巡逻队员登记</a>
	   	    <%-- <a href="<c:url value='/gzgl/xldrw/toListPage.action?queryBean.orgCode=${loginInfo.orgcode}'/>" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;巡逻队任务安排</a>--%>
	    	<a href="<c:url value='/gzgl/xldjl/toListPage.action?bean.orgCode=${loginInfo.orgcode}'/>" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;巡逻队奖励情况</a>
	    </div>
	</div>
</body>
</html>
