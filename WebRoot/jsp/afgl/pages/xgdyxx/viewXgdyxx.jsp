...
<creator:view title="协管队员信息">
	...
	<creator:panel id="addXgdyxx" tbarId="tbar" title="查看协管队员信息">
	<form id="add_xgdyxx_form" action="${contextPath}/xgdyxx/addXgdyxx.action" method="post">
				...
				<%-- 	<cps:row id="clear_row1">
					...
					<cps:row id="clear_row2">
						...
						<cps:tdContent cssStyle="width:20%">
							<cps:textfield id="fzrlxdh" name="xgdyxxBean.fzrlxdh" minlength="7" cssClass="validate[custom[phone]] cps-input" value="${xgdyxxBean.fzrlxdh }" cssStyle="width:80%"></cps:textfield>
						</cps:tdContent>
			...
			<cps:row>
				<cps:tdContent width="85%">
					...
					<cps:row id="sq_row">
						...
						<cps:tdContent cssStyle="width:30%">
							<cps:textfield id="dysfzh" name="xgdyxxBean.dysfzh" value="${xgdyxxBean.dysfzh }" readonly="true"></cps:textfield>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%"><font color="red">*</font>姓名：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:textfield id="dyxm" name="xgdyxxBean.dyxm" value="${xgdyxxBean.dyxm }"	readonly="true"></cps:textfield>
						</cps:tdContent>
						</cps:row>
					    <cps:row>
						<cps:tdLabel cssStyle="width:10%">性别：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:select id="dyxb" name="xgdyxxBean.dyxb"  value="${xgdyxxBean.dyxb }" zdlb="GB_XB" headerValue="---选择--" headerKey="" disabled="true"></cps:select>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%">出生日期：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:textfield id="dycsrq" name="xgdyxxBean.dycsrq" value="${xgdyxxBean.dycsrq}" readonly="true"></cps:textfield>
						</cps:tdContent>
						</cps:row>
					    <cps:row>
						<cps:tdLabel cssStyle="width:10%">联系电话：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:textfield id="dylxdh" name="xgdyxxBean.dylxdh" value="${xgdyxxBean.dylxdh }" readonly="true"></cps:textfield>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%">文化程度</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:select id="whcd" name="xgdyxxBean.whcd"  value="${xgdyxxBean.whcd }"
										 zdlb="GB_WHCD"  headerKey="" headerValue="--选择--" disabled="true">
							</cps:select>
						</cps:tdContent>
					</cps:row>
					<cps:row>
						<cps:tdLabel cssStyle="width:10%">户籍地：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:textfield id="dyhjdxz"  name="xgdyxxBean.dyhjdxz" ondblclick="selectXzqh('dyhjdqh','dyhjdxz')"  value="${xgdyxxBean.dyhjdxz }" maxlength="100" readonly="true"></cps:textfield>
							<input type="hidden" id="dyhjdqh"/>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%">现住地：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:textfield id="dyxzdxz"  name="xgdyxxBean.dyxzdxz"  value="${xgdyxxBean.dyxzdxz }" readonly="true"></cps:textfield>
						</cps:tdContent>
						</cps:row>
					   
					<cps:row id="clear_row5">
						<cps:tdLabel cssStyle="width:10%">上岗时间：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:date id="sgrq" name="xgdyxxBean.sgrq" dateFmt="yyyy-MM-dd" value="${xgdyxxBean.sgrq }" readOnly="true"></cps:date>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%">离岗时间：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:date id="lgrq" name="xgdyxxBean.lgrq" dateFmt="yyyy-MM-dd" value="${xgdyxxBean.lgrq }"  readOnly="true"></cps:date>
						</cps:tdContent>
						</cps:row>
					<cps:row>
						<cps:tdLabel cssStyle="width:10%">工作表现：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:select id="gzbx" name="xgdyxxBean.gzbx" value="${xgdyxxBean.gzbx}" headerValue="--选择--" headerKey="" zdlb="AF_GZBX" disabled="true"></cps:select>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%">工龄：</cps:tdLabel>
						<cps:tdContent cssStyle="width:30%">
							<cps:textfield id="gl"  name="xgdyxxBean.gl"  value="${xgdyxxBean.gl }" inputType="number" readonly="true"></cps:textfield>年
						</cps:tdContent>
				...
				<img src="<c:url value='/cps/common/showPoto.action'/>?sfzh=${xgdyxxBean.dysfzh}" title="全国人口库照片" alt="全国人口库照片" height="140" width="130"/>
					...
					<cps:row id="clear_row6">
						<cps:tdLabel cssStyle="width:10%">社会关系：</cps:tdLabel>
						<cps:tdContent colspan="5">
							<cps:textfield id="shgx" name="xgdyxxBean.shgx"  value="${xgdyxxBean.shgx }" 
								cssStyle="width:93%;height:80px;"  type="textarea" maxlength="150" readonly="true"></cps:textfield>
						</cps:tdContent>
					</cps:row>
					<cps:row id="clear_row6">
						...
						<cps:tdContent colspan="5">
							<cps:textfield id="dyjl" name="xgdyxxBean.dyjl"  value="${xgdyxxBean.dyjl }" 
								cssStyle="width:93%;height:80px;"  type="textarea" maxlength="1500" readonly="true"></cps:textfield>
						</cps:tdContent>
					</cps:row>
					...
					<cps:tdLabel>备注：</cps:tdLabel>
						<cps:tdContent colspan="5">
							<cps:textfield id="bz"  name="xgdyxxBean.bz"  value="${xgdyxxBean.bz }" 
								cssStyle="width:93%;height:80px;"	type="textarea" maxlength="60" readonly="true"></cps:textfield>
						</cps:tdContent>
					</cps:row>
					<cps:row>
						...
						<cps:tdContent cssStyle="width:25%">
							<cps:textfield id="djrxm" name="xgdyxxBean.djrxm"
								 value="${xgdyxxBean.djrxm}" readonly="true" ></cps:textfield>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%">登记时间：</cps:tdLabel>
						<cps:tdContent cssStyle="width:20%">
							<cps:textfield id="djsj" name="xgdyxxBean.djsj"  value="${xgdyxxBean.djsj}" readonly="true"></cps:textfield>
						</cps:tdContent>
						<cps:tdLabel cssStyle="width:10%">登记单位：</cps:tdLabel>
						<cps:tdContent cssStyle="width:20%">
							<cps:textfield id="djrdwmc" name="xgdyxxBean.djrdwmc"
								value="${xgdyxxBean.djrdwmc }" readonly="true"></cps:textfield>
						</cps:tdContent>
					</cps:row>
				</cps:table>
					</form>
