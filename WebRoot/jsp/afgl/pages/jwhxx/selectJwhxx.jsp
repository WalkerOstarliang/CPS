...
<creator:Script src="/jsp/afgl/js/jwhlist.js"></creator:Script>
	<creator:panel id="xldcx" title="选择居委会">
		<form id="xldqueryform" >
			<cps:table>
				...
				<cps:row>
					<cps:tdContent align="center" colspan="6">
						<cps:button value="查询" onclick="jxQuery()"></cps:button>
						<cps:button value="确定" onclick="returnJwhxx()"></cps:button>
	...
	<cps:tableGrid id="xldquerylist" 
				mutilSelect="true" dblclick="rowClickEvent"
