...
<creator:view  title="卡口盘查高级查询">
		<creator:panel id="gjafglkkpcxx" title="卡口盘查高级查询">
			<form id="gjsearchform">
				<cps:table>
					...
					<cps:row>
						...
						<cps:tdContent>
							<input type="hidden" id="kkbh" name="kkpcxxQuery.kkbh"/>
							<cps:textfield id="kkmc" name="kkpcxxQuery.kkmc"
								cssStyle="width:40%" ondblclick="selectKkxx('kkpcxxQuery','1')"></cps:textfield>
							<cps:button value="选择" onclick="selectKkxx('kkpcxxQuery','1')"></cps:button>
						</cps:tdContent>
					...
					<cps:row>
						<cps:tdContent colspan="6" align="center">
							<cps:button value="确定"  onclick="gjQueryKkpcxx();"></cps:button>
