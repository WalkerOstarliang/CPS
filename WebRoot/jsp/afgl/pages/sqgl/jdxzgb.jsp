...
<creator:view title="街道/乡镇干部管理">
	...
	<creator:panel id="xldglpanel" title="街道/乡镇干部基本信息" tbarId="sqglinfotab">
		...
		<input type="hidden" id="lx" name="bean.lx" value="3" />
		<cps:table id="gbxxtable">
			<cps:row>
				<cps:tdContent width="90%">
					<cps:table>
						<cps:row id="sq_row">
							<cps:tdLabel><font color="red">*</font>街道/乡镇名称：</cps:tdLabel>
							<cps:tdContent colspan="5">
								<c:choose>
									...
									<c:otherwise>
										...
										<cps:textfield id="sssqmc"  name="bean.sssqmc" value="${bean.sssqmc}" cssClass="validate[required] cps-input" appendPopuBtn="true" cssStyle="width:96%" readonly="true" onclick="openJdxxSelect(setJdxxToPage,4)"></cps:textfield>
									</c:otherwise>
								</c:choose>
							</cps:tdContent>
						</cps:row>
						...
						<cps:row id="clear_row2">
							...
							<cps:tdLabel width="15%"><font color="red">*</font>性别：</cps:tdLabel>
							<cps:tdContent>
						...
						<cps:row id="clear_row5">
					 	...
					 	<cps:row id="clear_row8">
							...
							<cps:tdContent colspan="5">
								<s:checkboxlist list="jdgbzwList" id="gbzw" name="bean.gbzws" listKey="dm" listValue="mc" cssClass="validate[required]"></s:checkboxlist>
							</cps:tdContent>
						</cps:row>
