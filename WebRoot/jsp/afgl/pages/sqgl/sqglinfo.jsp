...
<creator:view title="社区干部管理">
	...
	<creator:panel id="xldglpanel" title="社区干部基本信息" tbarId="sqglinfotab">
		...
		<input type="hidden" id="lx" name="bean.lx" value="1" />
							...
							<cps:tdContent colspan="5">
								<c:choose>
									...
									<c:otherwise>
										...
										<cps:textfield id="sssqmc"  name="bean.sssqmc" value="${bean.sssqmc}" cssClass="validate[required] cps-input" appendPopuBtn="true" cssStyle="width:96%" readonly="true" onclick="openSqxxSelectWin(setSqxxToPage)"></cps:textfield>
									</c:otherwise>
								</c:choose>
							</cps:tdContent>
						</cps:row>
