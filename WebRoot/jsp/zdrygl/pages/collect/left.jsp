...
<body class="leftbox">
	...
	<div id="left_menu" class="left_menu">
	    <div class="left_menubox">
	    	...
	    	<a href="${contextPath}/zdry/crime_toCrimeFzryInfoPage.action" class="left_menu_item_d" target="centerFrame"><img src="<c:url value='/template/cps/images/left_d01.jpg'/>" />&nbsp;犯罪人员认领</a>
	    </div>
	</div>
</body>
</html>