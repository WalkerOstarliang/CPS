		...
		<form id="ckyjQueryForm">
			<cps:table>
				...
				<cps:row>
					...
					<cps:tdLabel>是否反馈：</cps:tdLabel>
					<cps:tdContent>
						<s:select name="query.sffk" list="#{'0':'未反馈','1':'已反馈'}" listValue="value" listKey="key" headerValue=" " headerKey="" cssClass="cps-select"/>
					</cps:tdContent>
				</cps:row>
			</cps:table>
		</form>
	</creator:panel>
	<cps:tableGrid url="/zdry/ckyj/queryYjqsResultPageInfo.action" title="已签收常控预警信息"
			...
			<cps:column title="发布时间" field="yjfbsj"></cps:column>
			<cps:column title="发布单位" field="fbdw"></cps:column>
			<cps:column title="首次反馈时限" field="scczfksx"></cps:column>
			<cps:column title="是否反馈" field="sffkmc"></cps:column>
		</cps:tableGrid>
</creator:view>