...
<creator:panel id="zdyhbw_panel" title="重点要害部位" tbarId="zdyhbw_op">
	<div id="zdyhbw_div">
		...
		<input type="hidden" id="jgbh" name="dw.zdyhbw.jgbh" value="${dw.zdyhbw.jgbh}" />
		<cps:table>
			<cps:row>
				<cps:tdLabel width="12%"> <font color="red">*</font>要害部位名称：</cps:tdLabel>
				<cps:tdContent width="20%" colspan="5">
					<cps:textfield name="dw.zdyhbw.bwmc" id="bwmc" value="${dw.zdyhbw.bwmc}" required="true" maxlength="25" cssStyle="width:93%;"/>
				</cps:tdContent>
			</cps:row>
			<cps:row>
			...
			<cps:row>
				...
				<cps:tdContent colspan="5">
					<cps:textfield type="textarea" name="dw.zdyhbw.fw" id="fw" value="${dw.zdyhbw.fw}" required="true" maxlength="25" cssStyle="width:93%;height:30px;"/>
				</cps:tdContent>
			</cps:row>
			<cps:row>
				<cps:tdLabel>列入要害理由：</cps:tdLabel>
				<cps:tdContent colspan="5">
					<cps:textfield type="textarea" name="dw.zdyhbw.lryhbwly" id="lryhbwly" value="${dw.zdyhbw.lryhbwly}" maxlength="25" cssStyle="width:93%;height:30px;"/>
				</cps:tdContent>
			</cps:row>
			<cps:row>
			...
			<cps:row>
				...
				<cps:tdContent colspan="5">
					<cps:textfield name="dw.zdyhbw.bz" id="bz" value="${dw.zdyhbw.bz}" cssStyle="width:93%;" maxlength="150" />
				</cps:tdContent>
			</cps:row>
			<cps:row>
...
<form id="zdyhbwqueryform">
	<input type="hidden" name="dwcx.jgbh" value="${jgbh}"/>
</form>
