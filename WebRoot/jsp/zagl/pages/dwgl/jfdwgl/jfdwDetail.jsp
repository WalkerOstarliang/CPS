...
<cps:table>
	<cps:row>
		<cps:tdLabel width="15%"><font color='red'>*</font>首次申领时间：</cps:tdLabel>
		<cps:tdContent width="18%">
			<cps:date name="dw.jfdw.scslsj" value="${dw.jfdw.scslsj}" id="scslsj" required="true" dateFmt="yyyy-MM" maxDate="sysdate"></cps:date>
		</cps:tdContent>
		
		<cps:tdLabel width="15%"><font color='red'>*</font>备案等级：</cps:tdLabel>
		<cps:tdContent width="18%">
			<cps:select zdlb="ZDY_BADJ" name="dw.jfdw.badj" value="${dw.jfdw.badj}"  id="badj" required="true" headerKey="" headerValue=" "></cps:select>
		</cps:tdContent>
		
		<cps:tdLabel width="15%"><font color="red">*</font>备案类型：</cps:tdLabel>
		<cps:tdContent>
