			...
			<form id="tfsjya_form">
				...
				<cps:table>
					<cps:row>
						...
						<cps:tdContent>
							<cps:select name="dw.tfsjya.yalx" value="${dw.tfsjya.yalx}" headerKey="" headerValue="--请选择--" id="yalx"  required="true" zdlb="ZDY_YALX" />
						</cps:tdContent>
					...
					<cps:row>
						...
						<cps:tdContent width="18%">
							<cps:textfield name="dw.tfsjya.djrxm" value="${dw.tfsjya.djrxm}" id="djr" readonly="true"/>
						</cps:tdContent>
						
						<cps:tdLabel width="15%">登记时间：</cps:tdLabel>
						<cps:tdContent width="18%">
							<cps:textfield name="dw.tfsjya.djsj" value="${dw.tfsjya.djsj}" id="djsj" readonly="true"/>
						</cps:tdContent>
						
						<cps:tdLabel width="15%">登记单位：</cps:tdLabel>
						<cps:tdContent>
							<input type="hidden" name="dw.tfsjya.djdwdm" value="${dw.tfsjya.djdwdm}" />
							<cps:textfield name="dw.tfsjya.djdwmc" value="${dw.tfsjya.djdwmc}" id="djdwmc" readonly="true"/>
						</cps:tdContent>
					</cps:row>
				</cps:table>
			</form>
