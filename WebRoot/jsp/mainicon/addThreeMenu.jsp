	...
	<form id="menuform" method="post" enctype="multipart/form-data">
		...
		<cps:table>
			<cps:row>
				...
				<cps:tdContent>
					<cps:textfield id="title" name="menuBean.title" value="${menuBean.title}"></cps:textfield>
				</cps:tdContent>
			</cps:row>
			<cps:row>
				<cps:tdLabel>地址链接：</cps:tdLabel>
				<cps:tdContent>
					<cps:textfield id="title" name="menuBean.href" value="${menuBean.href}"></cps:textfield>
				</cps:tdContent>
			</cps:row>
			<cps:row>
				<cps:tdLabel>菜单图标：</cps:tdLabel>
				<cps:tdContent>
					<input type="file" id="imageicon" name="menuBean.imageicon" class="cps-file" style="width:70%"/>
				</cps:tdContent>
			</cps:row>
			<cps:row>
